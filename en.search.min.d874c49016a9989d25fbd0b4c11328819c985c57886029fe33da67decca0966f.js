...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.1425b2143e695d92769c4bf7b87d7decb2c7c817723680848164fbcff0317a93.js',function(){input.required=false;search();});}
